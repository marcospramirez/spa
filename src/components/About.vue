<template>
    <div id="about" class="content">
        ...
        <p>A Texas-born web developer living and working in San Diego, I have two years professional
            experience working with PHP(Symfony), JavaScript, HTML, CSS, and MySQL databases. </p>
